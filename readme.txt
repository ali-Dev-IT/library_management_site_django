...
then the site well be opened
if you want to open the admin page of the site add '/admin' after the IP address in search browser
'then enter this login information : 'username' => 'ali_sh' , 'password' => '12345  